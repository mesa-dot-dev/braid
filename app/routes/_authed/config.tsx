        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Choose which services and products you want to monitor. You'll
              receive notifications when there are incidents affecting your
              selected products.
            </p>
          </div>
                        ...
                        <CardContent className="p-0">
                          <div className="py-2 px-6">
                            <Input
                              ...
                              onChange={(e) =>
                                handleProductSearch(service.id, e.target.value)
                              }
                              className="w-full"
                          ...
                          <div className="divide-y">
                            {getFilteredProducts(service).map((product) => {
                              const isEnabled = enabledProducts.has(
                              ...
                              return (
                                <button
                                  ...
                                  onClick={() =>
                                    toggleProduct(service.id, product.id)
                                  }
                                >
