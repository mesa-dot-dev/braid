...
function ConfigComponent() {
  ...
  const filteredServices = useCallback(
    (product: (typeof products)[0]) => {
      ...
      return product.services.filter((service) =>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              Choose which services and products you want to monitor. You'll receive notifications when there
              are incidents affecting your selected products.
            </p>
          </div>
